...
<?php $__env->startSection('assets'); ?>
    <script src="<?php echo e(asset('scripts/checkout.js'), false); ?>" defer></script>
  ...
  <div class="row">
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <ul class="list-group mb-3">
        ...
        <input type="hidden" value="<?php echo e($amount=0, false); ?>"/>
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <input type="hidden" value="<?php echo e($amount=$amount+$item->quantity, false); ?>"/>
        ...
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          ...
          <input class="text-muted col-2" style = "text-align: right;" value="<?php echo e($cost, false); ?>"/>
        </li>
        <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
        ...
        <li class="list-group-item d-flex justify-content-between">
          ...
          <input class="text-muted col-2" style = "text-align: right;" id="total" name="total" value="<?php echo e($cost+5, false); ?>"/>
        </li>
      </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WearFamily\resources\views/checkout.blade.php ENDPATH**/ ?>