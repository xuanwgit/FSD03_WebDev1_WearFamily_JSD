...
<head>
    ...
    <title>{{ config('app.name', 'Wear_Family') }}</title>
    ...
    <!-- FavIcon -->
    <link rel="icon" type="image/png" href="{{ asset('/images/We\'arFamilyFavicon.png') }}">
...
<body>    
    <img id="scroll-top" title="Go to top" alt="go to top button" src="{{ asset('/images/to-top.png')}}"/>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light my-3 py-1">
        <div class="userInfo navbar-collapse collapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item m-1">
                            ...
                            @endif
                            <li class="nav-item m-1">
                                <img src="{{ asset('/images/register.png')}}" alt="register">
                            </li>
                        ...
                        @else
                            <li class="nav-item mt-2">
                                <img src="{{ asset('/images/logged.png')}}" alt="logged">
                            </li>
                            ...
                            @endguest
                        <li class="nav-item">
                            <a class="nav-link" href="/cart"><img src="{{ asset('/images/shoppingBag.png')}}" alt="shopping bag"></a>
                        </li>
                    </ul>
                </div>
    </nav>
        ...
        <!-- Header -->
        <div class="row">
            <img src="{{ asset('/images/We\'arFamilyLogo.png')}}" alt="Wear Family Logo" class="mt-5">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light my-3">
            <div class="container-xl">
                <a class="navbar-brand m-1" href="/index">
                    <img src="{{ asset('/images/We\'arFamilyLogoSmall.png')}}" alt="We'Ar Family Icon" height="50" >
                </a>
        ...
        <div class="col-lg-12 col-12 p-sm-2">
            <div class="">
                <ul class="list-unstyled small text-muted text-center">
                    <li>
                        <a href="./index">
                            <img src="{{ asset('images/We\'arFamilyLogo.png')}}" alt="Wear Family logo" width="250" class="pb-3"/>
                        </a>
                    </li>
                    <li class="mx-3">
                    </li>
                    <li class="my-3 d-flex justify-content-center">
                        <div class="d-flex">
                            <img src="{{ asset('images/follow-us.png')}}" alt="Follow us" title="Follow Us" class="ps-2 pe-3">
                            <a href="#">
                                <img src="{{ asset('images/Instagram.png')}}" alt="Instagram" title="KTB Instagram" class="px-3">
                            </a>
                            <a href="#">
                                <img src="{{ asset('images/facebook.png')}}" alt="Facebook" title="KTB Facebook" class="px-3">
                            </a>
                            <a href="#">
                                <img src="{{ asset('images/pinterest.png')}}" alt="Pinterest" title="KTB Pinterest" class="px-3">
                            </a>
                        </div>
                    </li>
                </ul>
